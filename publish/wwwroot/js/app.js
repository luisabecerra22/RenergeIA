...
window.renderCurvaS = function (canvasId, labels, planificado, real) {
    ...
    _charts[canvasId] = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [
                {
                    label: '% Acumulado Planificado (Línea Base)',
                    data: planificado,
                    borderColor: '#183963',
            ...
            plugins: {
                legend: {
                    ...
                    labels: {
                        ...
                        boxWidth: 30, boxHeight: 3, padding: 16,
                        usePointStyle: false
                    }
                },
                tooltip: {
                    backgroundColor: 'rgba(24,57,99,0.92)',
                    titleFont: { family: 'Montserrat, sans-serif', size: 11 },
